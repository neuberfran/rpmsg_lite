...
static int pico_pi_m4_pinmux_init(struct device *dev)
{
	...
	IOMUXC_SW_MUX_CTL_PAD_UART6_RX_DATA =
		IOMUXC_SW_MUX_CTL_PAD_UART6_RX_DATA_MUX_MODE(0);
	IOMUXC_SW_MUX_CTL_PAD_UART6_TX_DATA =
		IOMUXC_SW_MUX_CTL_PAD_UART6_TX_DATA_MUX_MODE(0);
	IOMUXC_SW_PAD_CTL_PAD_UART6_RX_DATA =
		IOMUXC_SW_PAD_CTL_PAD_UART6_RX_DATA_PE_MASK  |
		IOMUXC_SW_PAD_CTL_PAD_UART6_RX_DATA_PS(3)    |
		IOMUXC_SW_PAD_CTL_PAD_UART6_RX_DATA_HYS_MASK |
		IOMUXC_SW_PAD_CTL_PAD_UART6_RX_DATA_DSE(0);

	IOMUXC_SW_PAD_CTL_PAD_UART6_TX_DATA =
		IOMUXC_SW_PAD_CTL_PAD_UART6_TX_DATA_PE_MASK  |
		IOMUXC_SW_PAD_CTL_PAD_UART6_TX_DATA_PS(3)    |
		IOMUXC_SW_PAD_CTL_PAD_UART6_RX_DATA_HYS_MASK |
		IOMUXC_SW_PAD_CTL_PAD_UART6_TX_DATA_DSE(0);
